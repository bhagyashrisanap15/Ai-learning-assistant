...
const ProfilePage = () => {
  ...
  const handleChangePassword = async (e) => {
    ...
    if (newPassword.length < 6) {
      toast.error("New password must be at least 6 characterrs long.");
      return;
    }
            ...
            <div>
              ...
              <div className="relative">
                ...
                <input
                  ...
                  required
                  className="w-full h-9 pl-9 pr-3 border border-neutral-200 rounded-lg bg-white text-neutral-900"
                />
              </div>
            </div>
